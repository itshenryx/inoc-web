            ...
            <AlertDialog.Portal>
                ...
                <AlertDialog.Content className={s.AlertDialogContent}>
                    <AlertDialog.Title className={s.AlertDialogTitle}>
                        ...
                        <svg onClick={() => {setAttached(undefined);setOpen(false);}} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-5 h-5">
                    ...
                    <AlertDialog.Description className={s.SelectFileDescription}>
                        {
                            files.map((data) => {
                                return (
                                    <button onClick={() => {setAttached(data); setOpen(false)}} className={s["select-file"]} >
                                        <h1>
